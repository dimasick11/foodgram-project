...
urlpatterns = [
    ...
    path('purchase/<int:recipe_id>/', views.remove_purchase, name='remove_purchase'),
    path('<username>/', views.profile, name='profile'),
    path('<username>/<int:recipe_id>/', views.single_recipe, name='recipe'),
    path('<username>/<int:recipe_id>/edit/', views.edit_recipe, name='edit_recipe'),
    path('<username>/<int:recipe_id>/remove/', views.remove_recipe, name='remove_recipe'),
]